                        ...
                        <div class="extra-nav header-2-nav">
                            <div class="extra-cell">
                                <div class="ap-btn-outer">
                                    <!-- <a href="contact.html" class="ap-btn from-top">Appointment</a> -->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-full p-t120 p-b90 bg-cover" style="background-image: url(images/background/bg-dkk.png); background-position: top left; background-size: 70%; opacity: 0.7; background-repeat: repeat;" id="material">
                <div class="container">
                    ...
                    <div class="section-head center wt-small-separator-outer">
                        ...
                        <h2>Our Action For The Future</h2>
                    </div>
                    <!-- TITLE END-->
                                    ...
                                    <div class="wt-info">
                                        ...
                                        <div class="team-social-center">
                                            <ul class="team-social-bar">
                                                <li><a href="https://smg.city/materiiklim" target="_blank"><i class="fa-brands fa-chrome"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 m-b30">
                                <div class="wt-team-1">
                                    ...
                                    <div class="wt-info">
                                        ...
                                        <div class="team-social-center">
                                            <ul class="team-social-bar">
                                                <li><a href="https://smg.city/materickrawalabuana" target="_blank"><i class="fa-brands fa-chrome"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 m-b30">
                                <div class="wt-team-1">
                                    ...
                                    <div class="wt-info">
                                        ...
                                        <div class="team-social-center">
                                            <ul class="team-social-bar">
                                                <li><a href="https://smg.city/materivectorborne" target="_blank"><i class="fa-brands fa-chrome"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 m-b30">
                                <div class="wt-team-1">
                                    ...
                                    <div class="wt-info">
                                        <div class="team-detail">
                                            <!-- <a href="https://smg.city/materipapandayan" target="_blank"><span class="team-position">Show More </span></a> -->
                                            <h3 class="m-t0 team-name">Flyer</h3>
                                        </div>
                                        <div class="team-social-center">
                                            <ul class="team-social-bar">
                                                <!-- <li><a href="https://smg.city/materipapandayan" target="_blank"><i class="fa-brands fa-chrome"></i></a></li> -->
